...
<div style={{flex: "none", width: "52px", height: "52px", borderRadius: "999px", background: "#FFCC7D", color: "#1F2A44", font: "700 20px var(--font-display)", display: "flex", alignItems: "center", justifyContent: "center"}}>S</div>
<div>
