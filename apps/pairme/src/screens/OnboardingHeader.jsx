...
<div style={{flex: "1"}}>
<div style={{font: "600 11.5px var(--font-body)", color: "#FFCC7D", letterSpacing: ".06em", textTransform: "uppercase"}}>Question {step} of 6 · skippable</div>
...
<rect x="0" y={glassY} width="34" height={glassH} fill="#FFCC7D" style={{transition: "y .42s cubic-bezier(.2,.8,.2,1),height .42s cubic-bezier(.2,.8,.2,1)"}}></rect>
...
<button onClick={skip} style={{border: "1.5px solid #FFCC7D", background: "transparent", color: "#FFCC7D", borderRadius: "999px", padding: "8px 12px", font: "600 12px var(--font-body)", cursor: "pointer", width: "100%"}}>Skip</button>
</div>
</div>
</>
  );
