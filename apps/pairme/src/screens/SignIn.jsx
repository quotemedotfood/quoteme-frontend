...
export default function SignIn(vm){
  const { alt, signIns, signInNote, history } = vm;
  return (
<>
<div>
<div style={{background: "var(--pm-chrome)", padding: "34px 22px 26px", textAlign: "center"}}>
<img src="/brand/pear-mark-inverse.svg" alt="PairMe" style={{width: "44px", height: "44px"}} />
...
<span style={{flex: "none", width: "24px", display: "flex", justifyContent: "center", alignItems: "center"}}>{p.icon}</span>
