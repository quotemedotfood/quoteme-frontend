  ...
  const filtered = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case 'rep_count': cmp = a.rep_count - b.rep_count; break;
        case 'product_count': cmp = a.product_count - b.product_count; break;
              ...
              <TableBody>
                {filtered.map((d) => (
                  <TableRow key={d.id} className="hover:bg-gray-50">
                    ...
                    <TableCell className="text-sm text-gray-500">{d.email_domain || '—'}</TableCell>
                    <TableCell className="text-sm text-gray-500">{d.region || '—'}</TableCell>
                    <TableCell className="text-sm text-right">{d.rep_count}</TableCell>
                    <TableCell className="text-sm text-right">{d.product_count}</TableCell>
                    <TableCell>
