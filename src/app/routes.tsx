...
import { QMAdminReviewQueueList, QMAdminReviewQueueDetail } from "./pages/admin/QMAdminReviewQueue";
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "review-queue", Component: QMAdminReviewQueueList },
          { path: "review-queue/:id", Component: QMAdminReviewQueueDetail },
        ],
      },
      {
