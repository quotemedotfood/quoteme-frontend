...
## Wave 3 — Secure Upload + Stack (Desi, May 29)

| File | Covers | Status |
|---|---|---|
| `SECURE_REP_CATALOG_UPLOAD.md` | SU-FE-1/2/3/5 (chef entry · rep email · tech landing · chef email). **SU-FE-4 killed — chef now mints the link.** | Full handoff + source |
| `SECURE_DROP_ZONE_STATUS.md`   | Chef-facing status string vocabulary (wire verbatim) — companion to the above | Locked |
| `STACK_PRICE_AND_PRODUCT_DRAWER.md` | STACK-FE-1/2/3/4 (prices default + `$—` · cell-scoped read-only product drawer · multi-pack data shape · mobile sheet) | Full handoff + source |

New raw sources: `source/screens-secure-catalog.jsx`, `source/screens-secure-public.jsx`,
`source/screens-stack-drawer.jsx`, `source/screens-stack.jsx`, `source/screens-stack-v2.jsx`.
