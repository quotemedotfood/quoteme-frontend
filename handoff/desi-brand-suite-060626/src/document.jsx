...
const FLOW_ROUTES = {
  ...
  "rep-incoming-autofired":   { component: "RepIncomingQuotePage", props: { flowState: "auto-fired" } },
  "rep-incoming-empty-menu":  { component: "RepIncomingQuotePage", props: { emptyMenu: true, quoteId: "Q-1062" } },
  "rep-review-3panel":        { component: "RepReviewThreePanelDesktop" },
  "rep-review-mobile":        { component: "RepReviewMobile" },
  "rep-incoming-coverage":    { component: "RepIncomingQuoteCoverage" },
  "rep-pricing":              { component: "RepPricingOnlyView" },
  "rep-pricing-table":        { component: "RepPricingTableRead" },
  "rep-pricing-table-edit":   { component: "RepPricingTableEdit" },
  "rep-pricing-table-bulk":   { component: "RepPricingTableBulk5" },
  "rep-catalog":              { component: "RepTriagePage" }, // stub — catalog confirm page later
  "rep-settings":             { component: "RepTriagePage" }, // stub

  // Desi May 31 — Rep-initiated customer + menu request (surfaces 1–3 + bulk seam)
  "rep-add-customer":         { component: "RepAddCustomerPage" },
  "rep-add-customer-desktop": { component: "RepAddCustomerDesktop" },
  "rep-request-sent":         { component: "RepRequestSentPage" },
  "rep-request-sent-desktop": { component: "RepRequestSentDesktop" },
  "rep-request-email":        { component: "ChefRequestEmailMobile" },
  "rep-request-landing":      { component: "ChefRequestLanding" },
  "rep-add-bulk":             { component: "RepAddBulkDesktop" },
  "rep-bulk-status":          { component: "RepBulkStatusDesktop" },
