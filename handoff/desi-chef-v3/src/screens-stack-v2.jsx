                      ...
                      <td
                        ...
                        <button
                          ...
                          title={builderActive ? selected ? "Remove from order guide" : "Add to order guide" : `${o.name} · ${o.pack}`}>
                            ...
                            <div className="text-[10.5px] ink-faint mt-0.5 leading-snug">{o.pack}</div>                            {/* Selection affordance — checkmark badge top-right */}
                            {builderActive &&
                          <span
                            aria-hidden="true"
                            style={{
...
function PinToStackDrawerDemo() {
  ...
  return (
    <div className="relative" style={{ minHeight: 760, background: "#fff" }}>
      ...
      <PinToStackDrawer open distributor={distributor} onClose={() => {}} />
    </div>
  );
}
